Perth's chef-repo as created while taking LinuxAcademy's chef course
====================================================================
I used CentOS 7 for the workstation and first node.
I used Ubuntu 12 (LTS) - Bare Image for the second node.

Getting things to work w/ CentOS 7 caused me to make some changes to the chef resources/recipes.
Getting this to work w/ Ubuntu after that, caused me to make some further deviations from the instructions.

Hopefully someone @ LA will find this usefull for when they want to update the course.
